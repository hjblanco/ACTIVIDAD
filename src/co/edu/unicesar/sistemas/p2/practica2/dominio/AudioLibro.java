...
public class AudioLibro extends Publicacion {
    ...
    public AudioLibro(double duracion, double peso, String formato, String isbn,String tipo, String titulo, String autor, int anio, double costo) {
        super(isbn, tipo, titulo, autor, anio, costo);
